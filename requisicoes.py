...
# Lendo o arquivo json para extrair somente os nomes para a pesquisa:
...
# Fazendo a pesquisa da data de nascimento a partir da lista de nomes extraida acima e montando o arquivo excel com as colunas 'Nome' e 'Data_Nascimento':
for nome in nomes:
